	...
	,"DEBPKG:debian/patchlevel - https://bugs.debian.org/567489 List packaged patches for 5.24.1-2ubuntu1 in patchlevel.h"
	...
	,"DEBPKG:fixes/Compress-Raw-Zlib-2.071-Adapt-tests-to-zlib-1.2.11.patch - [PATCH] Adapt tests to zlib 1.2.11"
	,"DEBPKG:fixes/0001-Adapt-tests-to-zlib-1.2.11.patch - [PATCH] Adapt tests to zlib 1.2.11"
